...
module.exports.challengeInit = async (amount, ctx, toUser) => {
...
const pushTransaction = async (amount, ctx, toUserSession) => {
  ...
  if (!fromUserSession.wallet || !fromUserSession.challenge) {
    console.log("TransactionInit:: wallet setup failed !");
